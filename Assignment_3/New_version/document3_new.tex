...
\begin{align}
	...
	\implies \lambda^2 - \lambda + 2 = 0 \label{eq:res}
\end{align} 
Hence, \eqref{eq:res} is the required characteristic equation for the given matrix $\vec{A}$.
The python code containing the solution to the first part of the problem is provided in
\begin{lstlisting}
